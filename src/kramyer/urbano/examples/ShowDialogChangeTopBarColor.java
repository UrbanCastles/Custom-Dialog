 ...
 */
public class ShowDialogChangeTopBarColor {
    public static void main(String[] args) {
        ...
        CustomDialog.showMessageBox(null, Message, FrameTitle, "OK", CustomDialog.ERR_MESSAGE, myBGColor, myFGColor, myTopColor);
    }
